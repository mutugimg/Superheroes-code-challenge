...
Revision ID: 4c1beccab215
Revises: 
Create Date: 2023-12-21 13:10:16.909336
...
def upgrade():
    ...
    sa.Column('hero_id', sa.DateTime(), nullable=True),
    sa.Column('power_id', sa.DateTime(), nullable=True),
